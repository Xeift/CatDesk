...
- People who are working on web development and crawlers. (MCP3000 enables ChatGPT Web to read elements and control your browser tab through chrome-devtools-mcp integration.)

# How does this work?

1. A ChatGPT Plus or Pro subscription is required.
2. MCP3000 runs as a local MCP server on your computer. It has the ability to run commands and edit files, just like Codex.
3. You can connect ChatGPT Web to MCP3000 using a Custom Connector, which is a feature available only to Plus and Pro users.
...
# Differences between ChatGPT + MCP3000, Codex, and the API (let's say Plus plan)
...
|       | ChatGPT + MCP3000                                | Codex                   | OpenAI API           |
| ----- | ------------------------------------------------ | ----------------------- | -------------------- |
